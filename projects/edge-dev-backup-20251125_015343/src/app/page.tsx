...
export default function Home() {
  ...
  const handleRunScan = async () => {
    ...
    try {
      ...
      const userProject = projects.find(p => p.tags && p.tags.includes('uploaded'));
                        ...
                        {sortedResults.map((result, index) => (
                          ...
                          >
                            ...
                            <td style={{
                              ...
                              {(result.gapPercent || result.gap_percent || 0).toFixed(1)}%
                            </td>
                            <td style={{
                              color: selectedTicker === result.ticker ? '#ffffff' : '#999999',
                              padding: '12px 16px',
                      ...
                      <tbody>
                        {sortedResults.map((result, index) => (
                          ...
                          >
                            ...
                            <td className={`p-2 text-sm font-semibold ${(result as any).result === 'win' ? 'text-green-400' : 'text-red-400'}`}>
