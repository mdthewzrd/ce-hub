...
} from '../../src/config/globalChartConfig';
...
export type { Timeframe } from '../../src/config/globalChartConfig';
export { GLOBAL_CHART_TEMPLATES as CHART_TEMPLATES } from '../../src/config/globalChartConfig';
