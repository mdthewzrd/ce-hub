...
def check_high_lvl_filter_lc(df):
    ...
    # SINGLE SCANNER LOGIC: lc_frontside_d2_extended_1
    ...
    df2 = df[df['lc_frontside_d2_extended_1'] == 1]
    return df2


def filter_lc_rows(df):
    # UPDATED FOR SINGLE SCANNER: lc_frontside_d2_extended_1
...
def get_min_price_lc(df):
    # SCANNER-SPECIFIC MIN PRICE: lc_frontside_d2_extended_1
...
async def main():
    ...
    df_lc.to_csv("lc_frontside_d2_extended_1_backtest.csv")
