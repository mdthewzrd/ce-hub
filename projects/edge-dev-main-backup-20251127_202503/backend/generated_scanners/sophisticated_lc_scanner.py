...
# P parameters - RESTORED TO QUALITY INSTITUTIONAL SETTINGS
P = {
    # hard liquidity / price - QUALITY RESTORED
    "price_min"        : 8.0,           # RESTORED: Quality minimum $8.0
    "adv20_min_usd"    : 30_000_000,    # RESTORED: Quality liquidity 30M ADV

    # backside context (absolute window)
    "abs_lookback_days": 1000,
    "abs_exclude_days" : 10,
    "pos_abs_max"      : 0.75,          # RESTORED: Quality threshold 0.75

    # trigger mold (evaluated on D-1 or D-2)
    "trigger_mode"     : "D1_or_D2",   # "D1_only" or "D1_or_D2"
    "atr_mult"         : 0.9,          # RESTORED: Quality ATR multiplier 0.9
    "vol_mult"         : 0.9,          # RESTORED: Quality volume multiplier 0.9

    # Relative D-1 vol (optional). Set to None to disable.
    "d1_vol_mult_min"  : None,         # Keep disabled for institutional use

    # NEW: Absolute D-1 volume floor (shares). Set None to disable.
    "d1_volume_min"    : 15_000_000,   # RESTORED: Quality volume 15M shares

    "slope5d_min"      : 3.0,          # RESTORED: Quality momentum slope 3.0
    "high_ema9_mult"   : 1.05,         # RESTORED: Quality EMA multiplier 1.05

    # trade-day (D0) gates - QUALITY RESTORED
    "gap_div_atr_min"   : 0.75,        # RESTORED: Quality gap threshold 0.75
    "open_over_ema9_min": 0.9,         # RESTORED: Quality EMA requirement 0.9
    "d1_green_atr_min"  : 0.30,        # RESTORED: Quality green candle 0.30
    "require_open_gt_prev_high": True, # RESTORED: Quality breakout requirement
