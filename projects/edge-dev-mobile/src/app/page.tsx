...
if __name__ == "__main__":
  ...
  return (
    <>
    <div className="min-h-screen" style={{ background: 'var(--studio-bg)', color: 'var(--studio-text)' }}>
        ...
        >
          <button
            ...
            onMouseEnter={(e) => {
              ...
              target.style.backgroundColor = 'rgba(212, 175, 55, 0.25)';
              target.style.borderColor = 'rgba(212, 175, 55, 0.6)';
              target.style.boxShadow = '0 4px 12px rgba(212, 175, 55, 0.2)';
              target.style.transform = 'translateY(-1px)';
            }}
            onMouseLeave={(e) => {
              const target = e.target as HTMLElement;
              target.style.backgroundColor = 'rgba(212, 175, 55, 0.15)';
              target.style.borderColor = 'rgba(212, 175, 55, 0.4)';
              target.style.boxShadow = '0 2px 8px rgba(212, 175, 55, 0.1)';
      ...
      <div
        ...
        style={{
          marginLeft: '18.5rem', /* Account for 288px (w-72) fixed sidebar with minimal gap */
          marginRight: '31rem', /* Account for 480px (w-120) fixed Renata + proper gap */
          width: 'calc(100vw - 49.5rem)',
          paddingTop: '0'
        }}
      >
        {/* Header */}
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <input
                    ...
                    onFocus={(e) => {
                      ...
                      e.target.style.boxShadow = '0 0 0 4px rgba(212, 175, 55, 0.2), 0 6px 16px rgba(212, 175, 55, 0.3)';
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: '16px' }}>
                  <button
                    ...
                    onMouseEnter={(e) => {
                      const target = e.target as HTMLElement;
                      target.style.borderColor = 'rgba(212, 175, 55, 0.8)';
                      target.style.color = '#D4AF37';
                      target.style.backgroundColor = 'rgba(212, 175, 55, 0.12)';
                    ...
                    onMouseLeave={(e) => {
                      ...
                      target.style.backgroundColor = 'rgba(17, 17, 17, 0.8)';
                      target.style.boxShadow = '0 3px 8px rgba(0, 0, 0, 0.2)';
                      target.style.transform = 'translateY(0)';
                    }}
                  >
                    30d
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '8px',
                  border: '1px solid rgba(212, 175, 55, 0.4)',
                  color: isExecuting ? 'rgba(255, 255, 255, 0.6)' : '#ffffff',
                  backgroundColor: isExecuting ? 'rgba(17, 17, 17, 0.8)' : 'rgba(212, 175, 55, 0.2)',
                  transition: 'all 0.2s ease',
                  ...
                  letterSpacing: '0.3px',
                  marginLeft: '12px',
                  boxShadow: isExecuting ? 'none' : '0 4px 12px rgba(212, 175, 55, 0.2)',
                  transform: isExecuting ? 'none' : 'translateY(0)'
                }}
                onMouseEnter={(e) => {
                  if (!isExecuting) {
                    e.target.style.backgroundColor = 'rgba(212, 175, 55, 0.3)';
                    e.target.style.borderColor = 'rgba(212, 175, 55, 0.6)';
                    e.target.style.boxShadow = '0 6px 16px rgba(212, 175, 55, 0.3)';
