...
import { Brain, Upload, Play, TrendingUp, BarChart3, Settings, Search, Target, Filter, Clock, Database, MessageCircle, ChevronUp, ChevronDown, Trash2, Edit2, RefreshCw, Save, Download, X, Check, Bug, Wand2, Image, Camera, ImageIcon } from 'lucide-react';
...
import StandaloneRenataChat from '@/components/StandaloneRenataChatSimple';
...
const target = e.target as HTMLElement;
        ...
        {/* Renata AI Assistant Button - V2 Transformation Features */}
        {!isRenataPopupOpen && (
          <div
            style={{
              padding: '16px 20px',
          ...
          >
            <button
            data-testid="renata-chat-open-button"
            data-renata="true"
      ...
      <div
        ...
        style={{
          ...
          width: 'calc(100vw - 296px)', /* Full viewport width minus sidebar */
          maxWidth: '100%',
          overflowX: 'auto', /* Changed from hidden to allow scrolling on small screens */
...
# Your code here...`
      ...
      {/* Renata AI Popup - Simple Version */}
      <StandaloneRenataChat
        isOpen={isRenataPopupOpen}
        onClose={() => setIsRenataPopupOpen(false)}
      />

      {/* Placeholder removed - Real Renata chat is now active */}
      ...
      <RenataSidebar
        isOpen={true}
        onClose={() => {}}
        activeProject={selectedResult?.project || null}
        onPage="scan"
      />
    </>
  );
