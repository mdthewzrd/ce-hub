...
const CreateProjectModal: React.FC<CreateProjectModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Optimistic UI update - close modal immediately while saving in background
      onClose();

      // Create project in background without blocking UI
      onSubmit(projectData).catch((error) => {
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="flex space-x-1 ml-2">
          <Button
            ...
            className="text-blue-400 hover:text-blue-600 hover:bg-blue-900/20 h-8 w-8 border border-blue-400/30 mr-2"
            title="Edit project"
          >
          ...
          <Button
            ...
            className="text-red-400 hover:text-red-600 hover:bg-red-900/20 h-8 w-8 border border-red-400/30"
