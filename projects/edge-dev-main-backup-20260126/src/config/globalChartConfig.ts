...
export const generateGlobalLayout = (
  ...
  const layout = {
    ...
    xaxis: {
      ...
      showspikes: true,          // Crosshair lines
      spikesnap: "cursor",
      spikemode: "across",
      spikecolor: "#EAB308",               // Brand gold color
      spikedash: "dash",                   // Match y-axis (dashed)
      spikethickness: timeframe === 'day' ? 1 : 1,  // Gold crosshair for all charts
    ...
    yaxis: {
      ...
      spikethickness: 1,                   // Gold crosshair for price axis
      autorange: false,          // ALWAYS use explicit range
    ...
    yaxis2: {
      ...
      spikecolor: "#EAB308",               // Brand gold color
      spikedash: "dash",                   // Dashed line with clear gaps
      spikethickness: 1,                   // Gold crosshair for volume axis
      autorange: false,          // ALWAYS use explicit range
...
export const generateGlobalMarketSessionShapes = (
  ...
  try {
    ...
    tradingDays.forEach((dateStr, index) => {
      ...
      // Create TWO rectangles for each section to leave gap in middle
      // Volume section (bottom): y0: 0, y1: 0.25
      shapes.push({
        type: 'rect',
        xref: 'x',
        yref: 'paper',
