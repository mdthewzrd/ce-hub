...
class ScannerConfig:
    ...
    scoring_array = ['high_low', 'high_pdc', 'low_pdc']
    scoring_array = ['high_low', 'high_pdc', 'low_pdc']
    scoring_array = ['date', 'ticker', 'lc_frontside_d2_extended']
    scoring_array = ['date', 'ticker']
    scoring_values = [9, 20, 50, 200]
    scoring_values = [5, 20, 50, 100, 250]
    high_pct_chg_>=_0.5 = 0.5
    c_ua_>=_5.0 = 5
    c_ua_<_15.0 = 15
    highest_high_5_dist_to_lowest_low_20_pct_1_>=_2.5 = 2.5
    high_pct_chg_>=_0.3 = 0.3
    c_ua_>=_15.0 = 15
    c_ua_<_25.0 = 25
    highest_high_5_dist_to_lowest_low_20_pct_1_>=_2.0 = 2
    high_pct_chg_>=_0.2 = 0.2
    c_ua_>=_25.0 = 25
    c_ua_<_50.0 = 50
    highest_high_5_dist_to_lowest_low_20_pct_1_>=_1.5 = 1.5
    high_pct_chg_>=_0.15 = 0.15
    c_ua_>=_50.0 = 50
    c_ua_<_90.0 = 90
    highest_high_5_dist_to_lowest_low_20_pct_1_>=_1.0 = 1
    high_pct_chg_>=_0.1 = 0.1
    c_ua_>=_90.0 = 90
    highest_high_5_dist_to_lowest_low_20_pct_1_>=_0.75 = 0.75
    high_chg_atr_>=_1.5 = 1.5
    dist_h_9ema_atr_>=_2.0 = 2
    dist_h_20ema_atr_>=_3.0 = 3
    v_ua_>=_10000000.0 = 10000000
    dol_v_>=_500000000.0 = 500000000
    c_ua_>=_5.0 = 5
    dist_l_9ema_atr_>=_1.0 = 1
    h_dist_to_highest_high_20_1_atr_>=_1.0 = 1
    dol_v_cum5_1_>=_500000000.0 = 500000000
    lc_frontside_d2_extended_==_1.0 = 1
...
# 3. 43 parameters are now user-configurable