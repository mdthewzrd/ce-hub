...
async function takeScreenshotAndValidate() {
  ...
  try {
    ...
    // Wait for page to load using correct syntax
    ...
    await page.screenshot({
      path: 'button_styling_validation_fixed.png',
      fullPage: false,
      clip: {
        x: 0,
        y: 0,
    ...
    console.log('✅ Screenshot saved as button_styling_validation_fixed.png');
    ...
    if (buttonInfo.found) {
      ...
      console.log(`✅ Button background color: ${buttonInfo.backgroundColor}`);
      console.log(`✅ Button margin left: ${buttonInfo.marginLeft}`);
    } else {
      console.log('❌ Load Saved Scans button NOT found');
    }
