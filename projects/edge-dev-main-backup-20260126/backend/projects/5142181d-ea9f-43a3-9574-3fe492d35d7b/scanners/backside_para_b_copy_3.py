...
A daily scanner that identifies stocks showing a strong bullish momentum pattern with specific volume and price action criteria. It looks for stocks where the prior day (D-1) or two days prior (D-2) shows strength, followed by a gap up on the trade day (D0) opening above the previous day's high.

Generated by RENATA_V2 - 2026-01-14 09:54:46
