...
A daily-only scanner that identifies A+ parabolic patterns with backside setups. Looks for stocks where D-1 (or D-2) shows strong momentum, followed by a gap up on D0 with specific volume and technical confirmation.

Generated by RENATA_V2 - 2026-01-20 21:51:44
