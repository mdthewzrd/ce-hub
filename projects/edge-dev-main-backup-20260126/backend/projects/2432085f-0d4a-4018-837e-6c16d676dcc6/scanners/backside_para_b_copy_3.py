...
A daily scanner that identifies stocks showing a strong bullish momentum pattern with specific gap-up and volume confirmation criteria. It looks for stocks where the prior day (D-1) or two days prior (D-2) shows strong price and volume action, followed by a gap-up open above the previous high on the trade day (D0).

Generated by RENATA_V2 - 2026-01-12 22:36:41
