...
A daily scanner that identifies stocks showing a 'backside' pattern where the prior day (D-1) or two days prior (D-2) exhibits strong momentum and the current day (D0) gaps up and opens above the previous day's high. The strategy looks for stocks with strong relative volume, price strength, and specific technical conditions.

Generated by RENATA_V2 - 2026-01-14 08:52:21
