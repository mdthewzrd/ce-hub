...
A daily scanner that identifies stocks showing a 'backside' pattern where the prior day (D-1) or two days prior (D-2) exhibits strong momentum and the current day (D0) gaps up and opens above the previous day's high. It filters for liquidity, volume, and trend confirmation.

Generated by RENATA_V2 - 2026-01-13 12:10:15
