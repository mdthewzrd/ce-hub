...
A daily scanner that identifies stocks showing a 'para backside' pattern, where the prior day (D-1) or day before that (D-2) sets up a strong momentum move, followed by a gap-up open on the trade day (D0) above the previous day's high. The strategy looks for strong volume confirmation and relative strength against historical averages.

Generated by RENATA_V2 - 2026-01-18 15:41:56
