...
A daily scanner that identifies stocks showing a strong bullish momentum pattern with specific volume and price action criteria. It looks for stocks where the prior day (D-1) or two days ago (D-2) showed strength, followed by a gap up on the trade day (D0) opening above the previous day's high.

Generated by RENATA_V2 - 2026-01-09 11:53:26
...
class backside_para_b_copy_3:
    ...
    def _process_ticker_optimized_pre_sliced(self, ticker_data: tuple):
        ...
        for i in range(2, len(m)):
            ...
            # This uses the extracted detection loop
            try:
                    for i in range(2, len(m)):
                            d0 = m.index[i]
                            r0 = m.iloc[i]       # D0
