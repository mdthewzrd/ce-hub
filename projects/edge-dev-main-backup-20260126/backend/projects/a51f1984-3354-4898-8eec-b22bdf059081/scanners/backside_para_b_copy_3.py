...
A daily scanner that identifies stocks showing a strong bullish momentum pattern with specific volume and price action criteria. It looks for stocks where the prior day (D-1) or two days ago (D-2) shows strong buying pressure, followed by a gap up and opening above the previous day's high.

Generated by RENATA_V2 - 2026-01-12 14:44:30
