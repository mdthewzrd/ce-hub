...
def check_high_lvl_filter_lc(df):
    ...
    df['lc_frontside_d3_extended_1'] = ((df['h'] >= df['h1']) & 
                        ...
                        # (((df['high_pct_chg1'] >= .5) & (df['high_pct_chg'] >= .3) & (df['c_ua'] >= 1) & (df['c_ua'] < 5) & (df['h_dist_to_lowest_low_20_pct']>=3)) |# & (df['gap_pct'] >=  .15)) |
                        (((df['high_pct_chg1'] >= .3) & (df['high_pct_chg'] >= .3) & (df['c_ua'] >= 1) & (df['c_ua'] < 15) & (df['h_dist_to_lowest_low_20_pct']>=2.5)) |# & (df['gap_pct'] >=  .15)) |
    ...
    df['lc_frontside_d2_extended'] = ((df['h'] >= df['h1']) & 
                        ...
                        # (((df['high_pct_chg'] >= .7) & (df['c_ua'] >= 1) & (df['c_ua'] < 5) & (df['highest_high_5_dist_to_lowest_low_20_pct_1']>=3)) |# & (df['gap_pct'] >=  .15)) |
                        (((df['high_pct_chg'] >= .5) & (df['c_ua'] >= 1) & (df['c_ua'] < 15) & (df['highest_high_5_dist_to_lowest_low_20_pct_1']>=2.5)) |# & (df['gap_pct'] >=  .15)) |
                        ...
                        (df['dist_l_9ema_atr'] >= 2) & 
                        
                        (df['h_dist_to_highest_high_20_1_atr']>=1)&

                        (df['dol_v_cum5_1']>=200000000)&
    ...
    df['lc_frontside_d2_extended_1'] = ((df['h'] >= df['h1']) & 
                        ...
                        # (((df['high_pct_chg'] >= 1) & (df['c_ua'] >= 1) & (df['c_ua'] < 5) & (df['highest_high_5_dist_to_lowest_low_20_pct_1']>=3)) |# & (df['gap_pct'] >=  .15)) |
                        (((df['high_pct_chg'] >= 1) & (df['c_ua'] >= 1) & (df['c_ua'] < 15) & (df['highest_high_5_dist_to_lowest_low_20_pct_1']>=2.5)) |# & (df['gap_pct'] >=  .15)) |
                        ...
                        # (df['dist_l_9ema_atr'] >= 0.5) & 
                        # (df['dist_l_20ema_atr'] >= 1.5) & 
    ...
    df['lc_frontside_d3_extended_2'] = ((df['h'] >= df['h1']) & 
                        ...
                        (((df['high_pct_chg'] >= .15) & (df['c_ua'] >= 1) & (df['c_ua'] < 15) & (df['h_dist_to_lowest_low_20_pct']>=1.5)) |
                        ((df['high_pct_chg'] >= .1) & (df['c_ua'] >= 15) & (df['c_ua'] < 25) & (df['h_dist_to_lowest_low_20_pct']>=1)) |
                        ((df['high_pct_chg'] >= .07) & (df['c_ua'] >= 25) & (df['c_ua'] < 50) & (df['h_dist_to_lowest_low_20_pct']>=.7)) |
                        ((df['high_pct_chg'] >= .05) & (df['c_ua'] >= 50) & (df['c_ua'] < 90) & (df['h_dist_to_lowest_low_20_pct']>=.5)) |
                        ((df['high_pct_chg'] >= .03) & (df['c_ua'] >= 90) & (df['h_dist_to_lowest_low_20_pct']>=.2)))  & 

                        (df['high_chg_atr1'] >= 0.5) & 
                        (df['high_chg_from_pdc_atr1'] >= 1) & 
                        (df['gap_atr1'] >= 0.2) & 
                        (df['close_range1'] >= 0.6) &                  
                        (df['c1'] >= df['o1']) & 
                        (df['dist_h_9ema_atr1'] >= 2) & 
                        ...
                        (df['high_chg_atr'] >= 1) & 
                        (df['high_chg_from_pdc_atr'] >= 1) & 
                        (df['gap_atr'] >= 0.2) & 
                        (df['close_range'] >= 0.6) &        
                        (df['c'] >= df['o']) & 
                        (df['dist_h_9ema_atr'] >= 3) & 
                        (df['dist_h_50ema_atr'] >= 5) & 
                        (df['v_ua'] >= 10000000) & 
                        (df['dol_v'] >= 100000000) & 
                        ...
                        (df['h_dist_to_lowest_low_5_atr'] >= 3) & 
    ...
    df['lc_frontside_d3_extended_3'] = ((df['h'] >= df['h1']) & 
                        (df['h1'] >= df['h2']) & 
    ...
    df['big_d2'] = ((df['h'] >= df['h1']) & 

                        (df['l'] >= df['l1']) & 


                        (((df['high_pct_chg'] >= .5) & (df['c_ua'] >= 1) & (df['c_ua'] < 15) & (df['h_dist_to_lowest_low_20_pct']>=2.5)) |# & (df['gap_pct'] >=  .15)) |
                        ((df['high_pct_chg'] >= .3) & (df['c_ua'] >= 15) & (df['c_ua'] < 25) & (df['h_dist_to_lowest_low_20_pct']>=2)) |# & (df['gap_pct'] >=  .1)) |
                        ((df['high_pct_chg'] >= .2) & (df['c_ua'] >= 25) & (df['c_ua'] < 50) & (df['h_dist_to_lowest_low_20_pct']>=1.5)) |# & (df['gap_pct'] >=  .05)) |
                        ((df['high_pct_chg'] >= .15) & (df['c_ua'] >= 50) & (df['c_ua'] < 90) & (df['h_dist_to_lowest_low_20_pct']>=1)) |# & (df['gap_pct'] >=  .05)) |
                        ((df['high_pct_chg'] >= .1) & (df['c_ua'] >= 90) & (df['h_dist_to_lowest_low_20_pct']>=0.75)))  & # & (df['gap_pct'] >=  .03))) &
                        ...
                        (df['h_dist_to_highest_high_20_1_atr']>=2)&
                        (df['h_dist_to_lowest_low_5_atr']>=5)&
    ...
    # df['lc_frontside_d2_uptrend'] = ((df['high_chg_atr'] >= 1) & 
    #                     (df['close_range'] >= 0.7) &           
    #                     (df['c'] >= df['o']) & 
    #                     (df['dist_h_9ema_atr'] >= 2) & 
    #                     (df['dist_h_20ema_atr'] >= 3) & 
    ...
    columns_to_check = ['lc_frontside_d3_extended_1', 'lc_frontside_d2_extended', 'lc_frontside_d2_extended_1', 'lc_frontside_d3_extended_2', 'lc_frontside_d3_extended_3', 'lc_frontside_d4_para', 'big_d2']
...
def filter_lc_rows(df):
    ...
    return df[(df['lc_frontside_d3_extended_1'] == 1) | (df['lc_frontside_d2_extended'] == 1) | (df['lc_frontside_d2_extended_1'] == 1) | (df['lc_frontside_d3_extended_2'] == 1) | (df['lc_frontside_d3_extended_3'] == 1) | (df['lc_frontside_d4_para'] == 1) | (df['big_d2'] == 1)]
...
def compute_indicators1(df):
    ...
    df['close_range'] = (df['c'] - df['o']) / (df['h'] - df['o'])
...
async def main():
    ...
    date_search = '2024-03-07'
    date_search = pd.to_datetime(date_search)
    df_ticker_search = df[(df['date']==date_search)&(df['ticker']=="TSM")]
    df_ticker_search.to_csv("ticker_search.csv")
