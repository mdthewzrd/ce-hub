...
A daily scanner that identifies stocks showing a specific 'A+ para backside' pattern, where D-1 or D-2 forms a trigger setup, followed by a gap-up open above the previous day's high, with strong volume and momentum confirmation.

Generated by RENATA_V2 - 2026-01-07 21:06:28
...
class backside_para_b_copy_3:
    ...
    def __init__(self):
        ...
        self.strategy_name = "Daily Para Backside Lite Scan"
