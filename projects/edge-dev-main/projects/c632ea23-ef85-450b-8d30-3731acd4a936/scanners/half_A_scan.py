...
The provided scanner code is incomplete and lacks the core logic for detecting any specific trading pattern. It only includes data fetching and metric computation functions without the actual pattern detection or entry/exit conditions.

Generated by RENATA_V2 - 2026-01-20 09:23:24
