...
class OpenRouterAICodeFormatter {
  ...
  async formatCode(
    ...
    // All models failed - NO FALLBACK - Force AI agent workflow
    throw new Error(`All OpenRouter AI models failed. AI agent workflow required - no local fallback allowed. Tried ${modelsToTry.length} models.`);
  }
