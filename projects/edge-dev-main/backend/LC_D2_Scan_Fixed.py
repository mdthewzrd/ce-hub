...
Patterns: lc_frontside_d3_extended_1, lc_frontside_d2_extended, lc_frontside_d2_extended_1
...
class LC_D2_Scan_Fixed:
    ...
    },
    {
        ...
        print(f"🚀 MULTI-PATTERN SCANNER: LC_D2_Scan_Fixed")
