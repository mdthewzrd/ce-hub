...
A daily scanner that identifies stocks showing a 'backside' setup where the prior day (D-1) confirms strength relative to D-2, followed by a gap-up open on the trade day (D0) above the previous day's high. It filters for liquidity, volume, and momentum conditions.

Generated by RENATA_V2 - 2026-01-14 17:42:42
