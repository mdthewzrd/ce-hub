...
Identifies stocks that are not near their 2-year highs (backside), showing strong recent momentum and volume, with specific technical setups indicating potential reversal or breakout plays.

Generated by RENATA_V2 - 2026-01-20 08:42:35
...
class backside_para_A:
    ...
    def fetch_grouped_data(self):
        ...
        print(f"  📅 Fetching data from {self.scan_start} to {self.d0_end_user}")
