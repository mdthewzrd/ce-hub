"""
lc_d2_scan_oct_25_new_ideas_4

Multi-Pattern Scanner - 6 patterns

Generated by RENATA_V2 - Multi-Scanner to V31 Transformation
Date Range: 2024-01-01 to 2024-12-31
Patterns: lc_frontside_d2_uptrend_min_price, big_d2, lc_frontside_d3_extended_2_min_price, lc_frontside_d4_para, lc_backside_d3_extended_2_min_price, lc_backside_d4_para_min_price, lc_backside_d2_min_price, lc_frontside_d2_min_price, lc_backside_d3_extended_1_min_price, lc_frontside_d3_uptrend_min_price...
...
class lc_d2_scan_oct_25_new_ideas_4:
    """
        ...
        self.pattern_assignments = [
    {
        ...
        "logic": "(h >= h1) & (h1 >= h2) & (l >= l1) & (l1 >= l2) & ((high_pct_chg1 >= 0.3) & (high_pct_chg >= 0.3) & (c_ua >= 1) & (c_ua < 15) & (h_dist_to_lowest_low_20_pct >= 2.5) | (high_pct_chg1 >= 0.2) & (high_pct_chg >= 0.2) & (c_ua >= 15) & (c_ua < 25) & (h_dist_to_lowest_low_20_pct >= 2) | (high_pct_chg1 >= 0.1) & (high_pct_chg >= 0.1) & (c_ua >= 25) & (c_ua < 50) & (h_dist_to_lowest_low_20_pct >= 1.5) | (high_pct_chg1 >= 0.07) & (high_pct_chg >= 0.07) & (c_ua >= 50) & (c_ua < 90) & (h_dist_to_lowest_low_20_pct >= 1) | (high_pct_chg1 >= 0.05) & (high_pct_chg >= 0.05) & (c_ua >= 90) & (h_dist_to_lowest_low_20_pct >= 0.75)) & (high_chg_atr1 >= 0.7) & (c1 >= o1) & (dist_h_9ema_atr1 >= 1.5) & (dist_h_20ema_atr1 >= 2) & (v_ua1 >= 10000000) & (dol_v1 >= 100000000) & (high_chg_atr >= 1) & (c >= o) & (dist_h_9ema_atr >= 1.5) & (dist_h_20ema_atr >= 2) & (v_ua >= 10000000) & (dol_v >= 100000000) & ((high_chg_atr >= 1) | (high_chg_atr1 >= 1)) & (h_dist_to_highest_high_20_2_atr >= 2.5) & ((h >= highest_high_20) & (ema9 >= ema20) & (ema20 >= ema50))"
    },
    {
        "name": "lc_frontside_d2_extended",
        "logic": "(h >= h1) & (l >= l1) & ((high_pct_chg >= 0.5) & (c_ua >= 1) & (c_ua < 15) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 2.5) | (high_pct_chg >= 0.3) & (c_ua >= 15) & (c_ua < 25) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 2) | (high_pct_chg >= 0.2) & (c_ua >= 25) & (c_ua < 50) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 1.5) | (high_pct_chg >= 0.15) & (c_ua >= 50) & (c_ua < 90) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 1) | (high_pct_chg >= 0.1) & (c_ua >= 90) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 0.75)) & (high_chg_atr >= 2) & (c >= o) & (dist_h_9ema_atr >= 2) & (dist_h_20ema_atr >= 3) & (v_ua >= 10000000) & (dol_v >= 100000000) & (dist_l_9ema_atr >= 2) & (h_dist_to_highest_high_20_1_atr >= 1) & (dol_v_cum5_1 >= 200000000) & ((h >= highest_high_20) & (ema9 >= ema20) & (ema20 >= ema50))"
    },
    {
        "name": "lc_frontside_d2_extended_1",
        "logic": "(h >= h1) & (l >= l1) & ((high_pct_chg >= 1) & (c_ua >= 1) & (c_ua < 15) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 2.5) | (high_pct_chg >= 0.5) & (c_ua >= 15) & (c_ua < 25) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 2) | (high_pct_chg >= 0.3) & (c_ua >= 25) & (c_ua < 50) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 1.5) | (high_pct_chg >= 0.2) & (c_ua >= 50) & (c_ua < 90) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 1) | (high_pct_chg >= 0.15) & (c_ua >= 90) & (highest_high_5_dist_to_lowest_low_20_pct_1 >= 0.75)) & (high_chg_atr >= 1.5) & (c >= o) & (dist_h_9ema_atr >= 2) & (dist_h_20ema_atr >= 3) & (v_ua >= 10000000) & (dol_v >= 100000000) & (h_dist_to_highest_high_20_1_atr >= 1) & (dol_v_cum5_1 >= 200000000) & ((h >= highest_high_20) & (ema9 >= ema20) & (ema20 >= ema50))"
    },
    {
        "name": "lc_frontside_d3_extended_2",
        "logic": "(h >= h1) & (h1 >= h2) & ((high_pct_chg >= 0.15) & (c_ua >= 1) & (c_ua < 15) & (h_dist_to_lowest_low_20_pct >= 1.5) | (high_pct_chg >= 0.1) & (c_ua >= 15) & (c_ua < 25) & (h_dist_to_lowest_low_20_pct >= 1) | (high_pct_chg >= 0.07) & (c_ua >= 25) & (c_ua < 50) & (h_dist_to_lowest_low_20_pct >= 0.7) | (high_pct_chg >= 0.05) & (c_ua >= 50) & (c_ua < 90) & (h_dist_to_lowest_low_20_pct >= 0.5) | (high_pct_chg >= 0.03) & (c_ua >= 90) & (h_dist_to_lowest_low_20_pct >= 0.2)) & (high_chg_atr1 >= 0.5) & (high_chg_from_pdc_atr1 >= 1) & (gap_atr1 >= 0.2) & (close_range1 >= 0.6) & (c1 >= o1) & (dist_h_9ema_atr1 >= 2) & (dist_h_20ema_atr1 >= 3) & (v_ua1 >= 10000000) & (dol_v1 >= 100000000) & (high_chg_atr >= 1) & (high_chg_from_pdc_atr >= 1) & (gap_atr >= 0.2) & (close_range >= 0.6) & (c >= o) & (dist_h_9ema_atr >= 3) & (dist_h_50ema_atr >= 5) & (v_ua >= 10000000) & (dol_v >= 100000000) & (h_dist_to_lowest_low_20_atr >= 5) & (h_dist_to_lowest_low_5_atr >= 3) & ((h >= highest_high_20) & (ema9 >= ema20) & (ema20 >= ema50))"
    },
    {
        "name": "lc_frontside_d3_extended_3",
        "logic": "(h >= h1) & (h1 >= h2) & ((high_pct_chg >= 0.15) & (c_ua >= 1) & (c_ua < 15) & (h_dist_to_lowest_low_20_pct >= 1.5) | (high_pct_chg >= 0.1) & (c_ua >= 15) & (c_ua < 25) & (h_dist_to_lowest_low_20_pct >= 1) | (high_pct_chg >= 0.07) & (c_ua >= 25) & (c_ua < 50) & (h_dist_to_lowest_low_20_pct >= 0.7) | (high_pct_chg >= 0.05) & (c_ua >= 50) & (c_ua < 90) & (h_dist_to_lowest_low_20_pct >= 0.5) | (high_pct_chg >= 0.03) & (c_ua >= 90) & (h_dist_to_lowest_low_20_pct >= 0.2)) & (high_chg_atr1 >= 0.3) & (high_chg_from_pdc_atr1 >= 1) & (close_range1 >= 0.5) & (c1 >= o1) & (dist_h_9ema_atr1 >= 1) & (high_chg1 >= high_chg * 0.4) & (v_ua1 >= 10000000) & (dol_v1 >= 100000000) & (high_chg_atr >= 0.6) & (high_chg_from_pdc_atr >= 1) & (gap_atr >= 0.2) & (close_range >= 0.4) & (c >= o) & (dist_h_9ema_atr >= 1.5) & (dist_h_20ema_atr >= 3) & (dist_h_50ema_atr >= 5) & (v_ua >= 10000000) & (dol_v >= 100000000) & (h_dist_to_lowest_low_20_atr >= 5) & (h_dist_to_lowest_low_5_atr >= 3) & ((h >= highest_high_20) & (ema9 >= ema20) & (ema20 >= ema50))"
    },
    {
        "name": "lc_frontside_d4_para",
        "logic": "(h >= h1) & (h1 >= h2) & ((high_pct_chg >= 0.15) & (c_ua >= 1) & (c_ua < 15) & (h_dist_to_lowest_low_20_pct >= 1.5) | (high_pct_chg >= 0.1) & (c_ua >= 15) & (c_ua < 25) & (h_dist_to_lowest_low_20_pct >= 1) | (high_pct_chg >= 0.07) & (c_ua >= 25) & (c_ua < 50) & (h_dist_to_lowest_low_20_pct >= 0.7) | (high_pct_chg >= 0.05) & (c_ua >= 50) & (c_ua < 90) & (h_dist_to_lowest_low_20_pct >= 0.5) | (high_pct_chg >= 0.03) & (c_ua >= 90) & (h_dist_to_lowest_low_20_pct >= 0.2)) & (dist_h_9ema_atr2 >= 1) & (dist_h_9ema_atr3 >= 1) & (dist_h_9ema_atr4 >= 1) & (c2 >= o2) & (dist_h_20ema_atr2 >= 1.5) & (high_chg_atr1 >= 0.3) & (high_chg_from_pdc_atr1 >= 1) & (gap_atr1 >= 0) & (close_range1 >= 0.3) & (c1 >= o1) & (dist_h_9ema_atr1 >= 1.5) & (dist_h_20ema_atr1 >= 3) & (v_ua1 >= 10000000) & (dol_v1 >= 100000000) & (high_chg_atr >= 0.3) & (high_chg_from_pdc_atr >= 1) & (gap_atr >= 0.25) & (close_range >= 0.3) & (c >= o) & (dist_h_9ema_atr >= 2) & (dist_h_50ema_atr >= 5) & (v_ua >= 10000000) & (dol_v >= 100000000) & (h_dist_to_lowest_low_20_atr >= 5) & (h_dist_to_lowest_low_5_atr >= 3) & ((h >= highest_high_20) & (ema9 >= ema20) & (ema20 >= ema50))"
    }
]
        ...
        print(f"🚀 MULTI-PATTERN SCANNER: lc_d2_scan_oct_25_new_ideas_4")
    ...
    def fetch_grouped_data(
        ...
        """
        print(f"\n🚀 STAGE 1: FETCH GROUPED DATA")
        print(f"📡 Fetching trading days from {start_date} to {end_date}...")

        trading_dates = self.get_trading_dates(start_date, end_date)
        print(f"📅 {len(trading_dates)} trading days to fetch")
    ...
    def run_scan(
        ...
        # Stage 1: Fetch grouped data
        stage1_data = self.fetch_grouped_data(start_date, end_date, workers)
        ...
        # Stage 2: Apply smart filters
        stage2_data = self.apply_smart_filters(stage1_data, workers)
...
if __name__ == "__main__":
    ...
    scanner = lc_d2_scan_oct_25_new_ideas_4()
