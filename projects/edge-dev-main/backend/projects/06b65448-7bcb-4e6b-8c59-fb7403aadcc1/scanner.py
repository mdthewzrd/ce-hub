...
A daily scanner that identifies stocks showing a 'para backside' pattern, where the prior day (D-1) or day before that (D-2) confirms a strong momentum move, followed by a gap-up open on the trade day (D0) above the previous day's high.

Generated by RENATA_V2 - 2026-01-09 10:10:26
...
class backside_para_b_copy_3:
    ...
    def _run_pattern_detection(self, data):
        ...
        The detection loop logic was 4647 characters and has been embedded below.
        ...
        try:
            ...
            print(f"  ⚠️  Error in v31 integration: {e}")
            import traceback
            traceback.print_exc()
            return pd.DataFrame()
