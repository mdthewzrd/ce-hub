"""
Backside_B_Test_Simple

A daily scanner that identifies stocks showing strong momentum with a specific backside pattern, where the prior day breaks out above recent highs and closes green, followed by a gap up on the trade day. It filters for liquidity, volume, and relative strength.

Generated by RENATA_V2 - 2026-01-12 21:56:19
...
def run_scan(d0_start=None, d0_end=None):
    ...
    scanner = Backside_B_Test_Simple(
        api_key=os.getenv('POLYGON_API_KEY', 'Fm7brz4s23eSocDErnL68cE7wspz2K1I'),
        d0_start=d0_start or "2025-01-01",
        d0_end=d0_end or "2025-01-31"
    )
