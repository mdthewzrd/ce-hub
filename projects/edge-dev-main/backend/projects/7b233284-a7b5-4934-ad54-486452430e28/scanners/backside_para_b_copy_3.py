...
A daily scanner that identifies stocks showing a specific bullish price action pattern ('A+ para, backside') where the prior day (D-1) or two days ago (D-2) sets up a trigger, and the trade day (D0) gaps and opens above the previous day's high. It requires strong volume confirmation and relative strength.

Generated by RENATA_V2 - 2026-01-20 07:59:38
