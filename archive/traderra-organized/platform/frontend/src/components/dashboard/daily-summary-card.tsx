...
export function DailySummaryCard({
  ...
  const avgRMultiple = trades.length > 0 ? trades.reduce((sum, trade) => sum + getRMultipleValue(trade, mode), 0) / trades.length : 0
  const totalR = trades.reduce((sum, trade) => sum + getRMultipleValue(trade, mode), 0)
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-6">
                          ...
                          <span className={cn(
                            ...
                            getRMultipleValue(trade, mode) >= 0 ? 'text-green-400' : 'text-red-400'
                          )}>
