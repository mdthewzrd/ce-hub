...
# 📋 PRESERVED: calculate_trading_days (METRIC FUNCTION)
...
# 📋 PRESERVED: get_offsets (METRIC FUNCTION)
...
# 📋 PRESERVED: process_dataframe (WORKER FUNCTION)
...
async def enhanced_scan_with_preserved_logic(
    ...
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
        ...
        futures = {
            executor.submit(process_dataframe, ticker, start_date, end_date, parameters): ticker
            for ticker in tickers
        }
