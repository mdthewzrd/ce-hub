...
def check_high_lvl_filter_lc(df):
    ...
    # SINGLE SCANNER LOGIC - lc_frontside_d3_extended_1 ONLY
    ...
    # Filter to only rows with this scanner triggered
...
def get_min_price_lc(df):
    # SCANNER-SPECIFIC MIN PRICE - lc_frontside_d3_extended_1 only
...
async def main():
    ...
    df_lc.to_csv("lc_frontside_d3_extended_1_backtest.csv")
