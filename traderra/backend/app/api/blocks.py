...
class BlockTemplate(BaseModel):
    ...
    category: str = Field(..., regex="^(basic|media|trading|advanced|ai)$")
    block_type: str = Field(..., regex="^(tradeEntry|strategyTemplate|performanceSummary|paragraph|heading|list)$")
...
class BlockTemplateUpdate(BaseModel):
    ...
    description: Optional[str] = None
    category: Optional[str] = Field(None, regex="^(basic|media|trading|advanced|ai)$")
    block_type: Optional[str] = Field(None, regex="^(tradeEntry|strategyTemplate|performanceSummary|paragraph|heading|list)$")
    template_data: Optional[Dict[str, Any]] = None
    is_active: Optional[bool] = None

class ContentModeUpdate(BaseModel):
    editor_mode: str = Field(..., regex="^(rich-text|blocks)$")
...
async def get_block_templates(
    category: Optional[str] = Query(None, regex="^(basic|media|trading|advanced|ai)$"),
