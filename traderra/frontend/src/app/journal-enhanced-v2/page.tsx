...
interface EnhancedJournalPageProps {
  className?: string
}

export default function EnhancedJournalPageV2({ className }: EnhancedJournalPageProps) {
  ...
  return (
    <ToastProvider>
      <div className={cn('flex h-screen bg-[#0a0a0a] text-white', className)}>
        {/* Sidebar */}
        <div
          className={cn(
