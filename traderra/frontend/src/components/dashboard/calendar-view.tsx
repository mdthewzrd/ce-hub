...
function CalendarDay({ date, isCurrentMonth, pnl, trades, day }: CalendarDayProps) {
  ...
  return (
    <div className={cn(
      'min-h-[120px] p-3 studio-border border-[#1a1a1a] hover:bg-[#0f0f0f] transition-colors',
      ...
      {hasActivity ? (
        <div className="space-y-2">
          {/* P&L */}
          <div className={cn(
            'text-lg font-bold font-mono text-center py-1 px-2 rounded text-sm',
        ...
        <div className="flex items-center justify-center h-16">
          <span className="text-xs studio-muted">No trades</span>
        </div>
      )}
    </div>
  )
...
export function TradingCalendar() {
  ...
  return (
    <div className="studio-surface rounded-lg p-6">
      ...
      {/* Calendar Grid */}
      <div className="grid grid-cols-7 studio-border border-[#1a1a1a] rounded-lg overflow-hidden">
