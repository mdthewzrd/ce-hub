  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      ...
      <div className="studio-surface rounded-lg p-4">
        ...
        <div className="text-2xl font-bold text-trading-profit font-mono">
      ...
      <div className="studio-surface rounded-lg p-4">
        ...
        <div className="text-2xl font-bold text-trading-loss font-mono">
        ...
        {strategyData.map((strategy, index) => (
          <div key={index} className="flex items-center justify-between p-3 bg-[#0f0f0f] rounded-lg">
            ...
            <div className="text-right">
              <div className="text-sm font-bold text-trading-profit font-mono">
                ${strategy.totalPnL}
              </div>
            ...
            <div className="text-right">
              <div className="text-sm font-mono studio-text">
                ${strategy.avgPnL}
              </div>
