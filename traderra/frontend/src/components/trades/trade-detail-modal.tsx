  ...
  const handleFieldChange = (field: string, value: any) => {
    setEditedTrade(prev => {
      ...
      if (field === 'entryPrice' || field === 'exitPrice' || field === 'quantity') {
        const priceDiff = updated.exitPrice - updated.entryPrice
        const newPnL = priceDiff * updated.quantity
        const newPnLPercent = (priceDiff / updated.entryPrice) * 100
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      {isEditMode ? (
                        <input
                          ...
                          className="w-24 px-2 py-1 text-sm font-mono studio-text bg-[#0a0a0a] studio-border rounded focus:ring-2 focus:ring-primary focus:border-primary text-right"
                        />
                      ) : (
                        <span className="font-mono studio-text">${currentTrade.entryPrice.toFixed(2)}</span>
                      )}
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      {isEditMode ? (
                        ...
                        <span className="font-mono studio-text">{currentTrade.quantity.toLocaleString()} shares</span>
                      )}
                    </div>
                    <div className="flex justify-between">
                      <span className="studio-muted">Entry Value:</span>
                      <span className="font-mono studio-text">${entryValue.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      {isEditMode ? (
                        ...
                        <span className="font-mono studio-text">{currentTrade.strategy}</span>
                      )}
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      {isEditMode ? (
                        <input
                          ...
                          className="w-[214px] px-2 py-1 text-sm font-mono studio-text bg-[#0a0a0a] studio-border rounded focus:ring-2 focus:ring-primary focus:border-primary"
                        />
                      ) : (
                        <span className="font-mono studio-text">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      {isEditMode ? (
                        ...
                        <span className="font-mono studio-text">${currentTrade.exitPrice.toFixed(2)}</span>
                      )}
                    </div>
                    <div className="flex justify-between">
                      <span className="studio-muted">Quantity:</span>
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono studio-text">${exitValue.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      {isEditMode ? (
                        <input
                          ...
                          className="w-20 px-2 py-1 text-sm font-mono studio-text bg-[#0a0a0a] studio-border rounded focus:ring-2 focus:ring-primary focus:border-primary text-right"
                        />
                      ) : (
                        <span className="font-mono studio-text">${currentTrade.commission.toFixed(2)}</span>
                      )}
                    </div>
                    <div className="flex justify-between items-center">
                  ...
                  <div>
                    ...
                    {isEditMode ? (
                      <input
                        type="number"
                        step="0.01"
                        value={currentTrade.riskAmount ?? riskAmount}
                  ...
                  <div>
                    ...
                    {isEditMode ? (
                      <input
                        type="number"
                        step="0.1"
                        value={currentTrade.riskPercent ?? riskPercent}
                      ...
                      <div className="text-lg font-semibold studio-text">{riskPercent.toFixed(2)}%</div>
                    )}
                  </div>
                  <div>
                    ...
                    {isEditMode ? (
                      <input
                        type="number"
                        step="0.01"
                        value={currentTrade.stopLoss ?? stopLoss}
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className={cn('font-mono', grossPnL >= 0 ? 'text-trading-profit' : 'text-trading-loss')}>
                          ${grossPnL.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between border-t border-[#1a1a1a] pt-2">
                        ...
                        <span className={cn('font-mono font-medium', netPnL >= 0 ? 'text-trading-profit' : 'text-trading-loss')}>
                          ${netPnL.toFixed(2)}
                        </span>
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className={cn('font-mono', netPnL >= 0 ? 'text-trading-profit' : 'text-trading-loss')}>
                          {netPnL >= 0 ? '+1 Win' : '+1 Loss'}
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm">Strategy:</span>
                        <span className="font-mono studio-text">{trade.strategy}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className={cn('font-mono', rMultiple >= 0 ? 'text-trading-profit' : 'text-trading-loss')}>
                          {rMultiple >= 0 ? '+' : ''}{rMultiple.toFixed(2)}R
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm">Risk Reward:</span>
                        <span className="font-mono studio-text">1:{Math.abs(rMultiple).toFixed(1)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm">Position Size:</span>
                        <span className="font-mono studio-text">Optimal</span>
                      </div>
                    </div>
                  </div>
                </div>
