...
import { Brain, Settings, TrendingUp, BarChart3, FileText, Calendar } from 'lucide-react'
...
export function TopNav() {
  ...
  return (
    <nav className="h-16 studio-surface studio-border border-b px-6 flex items-center justify-between shadow-studio-lg" style={{
  ...
  return (
    <nav className="h-16 studio-surface studio-border border-b px-6 flex items-center justify-between shadow-studio-lg" style={{
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-3 pl-4 border-l border-[#1a1a1a]">
          <div className="h-8 w-8 rounded-full bg-primary flex items-center justify-center">
            <span className="text-sm font-semibold text-primary-foreground">T</span>
          </div>
          <div className="hidden sm:block">
