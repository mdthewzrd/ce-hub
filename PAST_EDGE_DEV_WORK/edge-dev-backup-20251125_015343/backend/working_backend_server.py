...
if __name__ == "__main__":
    print("🚀 Starting Working Backend Server on port 8003...")
    print("📡 Available endpoints:")
    print("  • Parameter Preview: http://localhost:8003/api/scan/parameters/preview")
    print("  • Code Formatter: http://localhost:8003/api/format/code")
    print("  • Projects API: http://localhost:8003/api/projects")
    print("  • Scan Execution: http://localhost:8003/api/scan")
