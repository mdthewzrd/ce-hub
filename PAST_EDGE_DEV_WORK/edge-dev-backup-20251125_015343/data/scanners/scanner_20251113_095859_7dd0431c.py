...
class ScannerConfig:
    ...
    min_price_col = "JoinedStr"
    min_pct_col = "JoinedStr"
    scoring_array = [9, 20, 50, 200]
    scoring_array = [5, 20, 50, 100, 250]
    scoring_array = ['high_low', 'high_pdc', 'low_pdc']
    pm_dol_vol_all = "BinOp"
    avg_pm_dol_vol = "Call"
    min_price_col = "BinOp"
    scoring_array = ['high_low', 'high_pdc', 'low_pdc']
    avg_pm_dol_vol_threshold = 10000000
    pm_dol_vol_next_day = "BinOp"
    pm_dol_vol_next_day = 0
    scoring_array = ['date_plus_1', 'date_minus_4', 'date_minus_30']
    scoring_array = ['ticker', 'date']
    scoring_array = ['date', 'ticker']
    scoring_array = ['vw', 't', 'n', 'vw_ua', 't_ua', 'n_ua']
    scoring_array = ['date', 'ticker']
    scoring_array = ['high_low', 'high_pdc', 'low_pdc']
    scoring_array = ['high_low', 'high_pdc', 'low_pdc']
    scoring_array = ['date', 'ticker']
    scoring_values = [9, 20, 50, 200]
    scoring_values = [5, 20, 50, 100, 250]
    high_pct_chg1_>=_0.3 = 0.3
    high_pct_chg_>=_0.3 = 0.3
    c_ua_>=_5.0 = 5
    c_ua_<_15.0 = 15
    h_dist_to_lowest_low_20_pct_>=_2.5 = 2.5
    gap_pct_>=_0.15 = 0.15
    high_pct_chg1_>=_0.2 = 0.2
    high_pct_chg_>=_0.2 = 0.2
    c_ua_>=_15.0 = 15
    c_ua_<_25.0 = 25
    h_dist_to_lowest_low_20_pct_>=_2.0 = 2
    gap_pct_>=_0.1 = 0.1
    high_pct_chg1_>=_0.1 = 0.1
    high_pct_chg_>=_0.1 = 0.1
    c_ua_>=_25.0 = 25
    c_ua_<_50.0 = 50
    h_dist_to_lowest_low_20_pct_>=_1.5 = 1.5
    gap_pct_>=_0.05 = 0.05
    high_pct_chg1_>=_0.07 = 0.07
    high_pct_chg_>=_0.07 = 0.07
    c_ua_>=_50.0 = 50
    c_ua_<_90.0 = 90
    h_dist_to_lowest_low_20_pct_>=_1.0 = 1
    gap_pct_>=_0.05 = 0.05
    high_pct_chg1_>=_0.05 = 0.05
    high_pct_chg_>=_0.05 = 0.05
    c_ua_>=_90.0 = 90
    h_dist_to_lowest_low_20_pct_>=_0.75 = 0.75
    gap_pct_>=_0.03 = 0.03
    high_chg_atr1_>=_0.7 = 0.7
    gap_atr1_>=_0.2 = 0.2
    close_range1_>=_0.6 = 0.6
    dist_h_9ema_atr1_>=_1.5 = 1.5
    dist_h_20ema_atr1_>=_2.0 = 2
    high_chg_atr_>=_1.0 = 1
    gap_atr_>=_0.2 = 0.2
    close_range_>=_0.6 = 0.6
    dist_h_9ema_atr_>=_1.5 = 1.5
    dist_h_20ema_atr_>=_2.0 = 2
    v_ua_>=_10000000.0 = 10000000
    dol_v_>=_500000000.0 = 500000000
    v_ua1_>=_10000000.0 = 10000000
    dol_v1_>=_100000000.0 = 100000000
    c_ua_>=_5.0 = 5
    high_chg_atr_>=_1.0 = 1
    high_chg_atr1_>=_1.0 = 1
    h_dist_to_highest_high_20_2_atr_>=_2.5 = 2.5
    lc_frontside_d3_extended_1_==_1.0 = 1
    v_ua_>=_2000000.0 = 2000000
    v_>=_20000000.0 = 20000000
    lc_frontside_d3_extended_1_==_1.0 = 1
...
# 3. 73 parameters are now user-configurable