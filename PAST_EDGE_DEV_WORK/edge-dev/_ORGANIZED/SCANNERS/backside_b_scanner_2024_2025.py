#!/usr/bin/env python3
"""
Backside B Scanner - Formatted for 1/1/24 - 11/1/25
==============================================
Original backside para b copy scanner with preserved parameters
"""
...
def scan_symbol(sym: str, start: str, end: str) -> pd.DataFrame:
    """Scan single symbol for backside B patterns"""
    try:
...
# ───────── MAIN EXECUTION ─────────
def main():
    print("🎯 BACKSIDE B SCANNER - 1/1/24 to 11/1/25")
    print("=" * 50)
    ...
    if results:
        ...
        print(f"\n🎯 BACKSIDE B RESULTS: {len(out)} signals found")
        print("=" * 100)
        print(out.to_string(index=False))

        # Save results
        output_file = "backside_b_results_2024_2025.csv"
        out.to_csv(output_file, index=False)
        print(f"\n💾 Results saved to: {output_file}")

    else:
        print("❌ No BACKSIDE B signals found.")
