            ...
            {activeTab === 'scanners' && (
              <div className="space-y-6">
                ...
                <ScannerSelector
                  ...
                  selectedScanners={scannerConfigs}
                  onSelectScanner={() => {}}
                  onRemoveScanner={() => {}}
                  onUpdateScanner={() => {}}
                  loading={isScanning}
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4">
                  {scanResults.map((result) => (
                    <div
                      key={result.id}
                      className="p-4 border rounded-lg cursor-pointer hover:bg-gray-800/50 transition-colors"
                      style={{ borderColor: 'var(--studio-border)', backgroundColor: 'var(--studio-surface)' }}
                      onClick={() => handleScanResultSelect(result)}
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div className="font-semibold text-studio-gold">{result.ticker}</div>
                          <div className="text-sm" style={{ color: 'var(--studio-muted)' }}>
                            {result.pattern}
                          </div>
