"""
Tests for Backtest Generator Agent
"""

import pytest
from backtest__generator_agent import BacktestGeneratorAgent
from core_v2.agent_framework.rag_enabled.rag_base import RAGConfig


class TestBacktestGeneratorAgent:
    """Test suite for Backtest Generator agent"""

    @pytest.fixture
    async def agent(self):
        """Create agent instance"""
        agent = BacktestGeneratorAgent()
