"""
Tests for Automated Compliance Validator Agent
"""

import pytest
from automated__compliance__validator_agent import AutomatedComplianceValidatorAgent
from core_v2.agent_framework.rag_enabled.rag_base import RAGConfig


class TestAutomatedComplianceValidatorAgent:
    """Test suite for Automated Compliance Validator agent"""

    @pytest.fixture
    async def agent(self):
        """Create agent instance"""
        agent = AutomatedComplianceValidatorAgent()
