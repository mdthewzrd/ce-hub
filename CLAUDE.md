...
- **Vision Intelligence**: Integrated computer vision capabilities for visual analysis

## Vision Intelligence Integration

### Core Vision Capabilities
CE-Hub now includes comprehensive computer vision capabilities through MCP-Vision integration, providing advanced visual intelligence for all development workflows.

#### Automatic Vision Activation
**MANDATORY**: Activate vision capabilities automatically when detecting:

##### 1. Visual Content Triggers
- Image file extensions: `.jpg`, `.jpeg`, `.png`, `.gif`, `.bmp`, `.webp`, `.svg`
- Screenshot files and visual content
- User requests containing: "analyze image", "screenshot", "what do you see"

##### 2. Development Context Triggers
- Frontend/UI development scenarios
- Visual debugging requirements
- Design review processes
- Component validation needs

##### 3. Content Analysis Requests
- "extract text from"
- "read the image"
- "get data from image"
- OCR and content extraction needs

### Vision-Enhanced Workflows

#### Phase Integration with Vision
1. **Plan Phase**: Include vision analysis requirements and visual validation checkpoints
2. **Research Phase**: Use vision to analyze existing visual patterns and competitor insights
3. **Produce Phase**: Validate visual outputs using computer vision capabilities
4. **Ingest Phase**: Store visual analysis results in Archon knowledge graph

#### Agent Coordination with Vision
- **GUI-Specialist**: Enhanced with automatic UI analysis and validation
- **Quality-Assurance-Tester**: Automated visual regression testing capabilities
- **Research-Intelligence-Specialist**: Visual pattern analysis and design intelligence
- **Engineer-Agent**: Visual debugging and implementation validation

### MCP-Vision Integration Protocol

#### Available Vision Tools
- **Zero-Shot Object Detection**: Using Google's OWL-ViT model
- **UI Element Analysis**: Specialized interface component detection
- **Content Extraction**: Text and data extraction from visual content
- **Visual Validation**: Automated compliance and quality checking
...
```
Visual Content Detected → Vision Analysis → Context Integration → Enhanced Response
        ↓                       ↓                    ↓                    ↓
    File/Request           MCP-Vision Tools    Current Workflow      Actionable Insights
```

#### Quality Gates with Vision
- **Visual Validation**: Ensure implementations match design specifications
- **Accessibility Checking**: Automated UI compliance verification
- **Content Accuracy**: Verify visual content meets requirements
...
### AUTOMATIC Agent Delegation (MANDATORY)

**Claude MUST automatically invoke appropriate specialist agents based on request patterns. Do NOT require manual delegation.**

#### Automatic Delegation Rules:

**Research-Intelligence-Specialist**: Auto-trigger when user asks "How to...", "What's the best way...", "Help me understand...", or when analysis is needed before implementation.

**Engineer-Agent**: Auto-trigger for "Implement...", "Build...", "Create code...", "Add feature...", or any technical implementation requests.

**GUI-Specialist**: Auto-trigger for UI/frontend requests, React components, interface design, or AI-enhanced user experience features.

**Quality-Assurance-Tester**: Auto-trigger after implementations complete, or for "Test...", "Validate...", "Check security...", performance issues.

**Documenter-Specialist**: Auto-trigger after major implementations, or for "Document...", "Create docs...", API documentation requests.

**CE-Hub-Orchestrator**: Auto-trigger for complex multi-phase projects, large-scale implementations, or requests involving multiple technologies.

#### Decision Logic:
```
ALWAYS assess task complexity:
- Simple (1-2 steps): Handle directly
- Medium complexity: Delegate to 1-2 appropriate specialists
- High complexity: Use ce-hub-orchestrator

ALWAYS start complex implementations with research-intelligence-specialist first.
```
