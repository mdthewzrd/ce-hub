"""
Tests for Trading Pattern Analyzer Agent
"""

import pytest
from trading__pattern__analyzer_agent import TradingPatternAnalyzerAgent
from core_v2.agent_framework.rag_enabled.rag_base import RAGConfig


class TestTradingPatternAnalyzerAgent:
    """Test suite for Trading Pattern Analyzer agent"""

    @pytest.fixture
    async def agent(self):
        """Create agent instance"""
        agent = TradingPatternAnalyzerAgent()
